...
def emojified(guess_string: str, secret_string: str) -> str:
    ...
    """We loop through the secret string and then test if the index matches exactly (green), whether there are any instances
    of the character in the string (yellow), and if nothing (white)"""
